  ...
  <div class="grid">
    <div class="col-12 lg:col-6 xl:col-3">
      <div class="card mb-0">
        <div class="flex justify-content-between mb-3">
          <div>
            <span class="block text-500 font-medium mb-3">Total Room Available</span>
    ...
    <div class="col-12 lg:col-6 xl:col-3">
      <div class="card mb-0">
        <div class="flex justify-content-between mb-3">
          <div>
            <span class="block text-500 font-medium mb-3">Total Room Occupied</span>
            <div class="text-900 font-medium text-xl">152</div>
          </div>
          <div
...
export default {
  data() {
    return {
      ...
      surfaceBorder: getComputedStyle(document.documentElement).getPropertyValue('--surface-border'),
    };
  },
  created() {
